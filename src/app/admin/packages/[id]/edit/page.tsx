    ...
    <div className="w-full py-8 pb-24">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input type="number" className={`mt-2 ${inp}`} placeholder="0" value={form.reviews}
        ...
        <CMSSection title="Hero Image" icon={<ImageIcon className="w-4 h-4" />}>
          <div className="mt-1">
            <CMSMediaSection
              image={form.heroImage} alt={form.heroAlt} editorType="Package"
