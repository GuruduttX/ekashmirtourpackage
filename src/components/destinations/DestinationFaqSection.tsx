...
/**
 * FAQ accordion — the closing section (SOP blueprint ends FAQ → CTA).
 *
 * Shared by the /destinations hub and each /destinations/[slug] page. The hub
 * gets the defaults; a destination page passes its own questions and heading.
 * Whatever is passed here is also what that page emits as FAQPage JSON-LD —
 * the schema is emitted by the PAGE, not here, because there is one FAQPage
 * block per URL and page.tsx already owns its structured data.
 *
...
export default function DestinationFaqSection({
  ...
  return (
    <section id="faq" className="w-full scroll-mt-24 bg-white py-10">
