...
export default function BookingCard({ pkg }: { pkg: Package }) {
  return (
    <div className="sticky top-28 w-full min-w-0 rounded-3xl border border-sky-100/60 bg-white p-6 sm:p-8 shadow-[0_12px_40px_rgba(0,0,0,0.06)]">
